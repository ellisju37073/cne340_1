...
def create_tables(cursor):
    cursor.execute('''CREATE TABLE IF NOT EXISTS fantasy (id INT PRIMARY KEY auto_increment,playername varchar(100), 
    position text CHARSET utf8, points varchar(100)); ''')
    return
